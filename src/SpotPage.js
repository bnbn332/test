          ...
          >
            <Grid item xs={12} align="right">
              <ButtonGroup
                ...
                aria-label="split button"
              >
                <Button className={classes.button} onClick={this.handleToggle}>{categorymarkers[findRoad] && categorymarkers[findRoad].getContent().replace(/(<([^>]+)>)/ig, ' ')} <ArrowDropUpIcon /></Button>
                <Button
